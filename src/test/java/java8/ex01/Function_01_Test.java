...
public class Function_01_Test {
	...
	// private Function<Integer, Person> intToPerson = new Function<Integer,
	// Person>(){
	//
	// @Override
	// public Person apply(Integer t) {
	// return new Person("first"+t,"last"+t,t,"pass"+t);
	// }
	//
	// }
	// ;
	...
	// private Function<Person, Account> personToAccount = new Function<Person,
	// Account>() {
	//
	//
	// @Override
